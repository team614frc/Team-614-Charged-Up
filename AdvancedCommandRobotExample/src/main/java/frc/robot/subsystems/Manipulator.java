...
public class Manipulator extends SubsystemBase {
  ...
  public Manipulator() {
    ...
    /*
     * We might not need the two motors for the gripper to follow each others
     * movements in the future, as there is a possibility
     * that we might need them to not match, in order to spin the game pieces onto
     * their designated
     * scoring locations
     */
  ...
  public void periodic() {
    // Periodically gets current motor is giving off, when the values exceeds the
    // threshold specified, motors stop

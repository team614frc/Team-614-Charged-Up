...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  public double getInches(){
    ...
    double wheelRevolutions = gearBoxOutputRevolutions * 
    (Constants.WHEEL_SHAFT_SPROCKET_TEETH/Constants.GEAR_BOX_SHAFT_SPROCKET_TEETH);
    double inchesTraveled = wheelRevolutions * Constants.M_PI * Constants.WHEEL_DIAMETER;

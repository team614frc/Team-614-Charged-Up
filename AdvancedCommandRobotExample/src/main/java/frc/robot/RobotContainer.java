...
public class RobotContainer {
    ...
    private final Command BlueCubeScoreCSAuto = new BlueCubeScoreCSAuto();
    private final Command RedConeScoreCSAuto = new RedConeScoreCSAuto();
    private final Command RedCubeScoreCSAuto = new RedCubeScoreCSAuto();
    ...
    public RobotContainer() {
        ...
        m_chooser.addOption("---Double Piece Autos---", DoNothing);

        m_chooser.addOption("Blue - Top Score Grab", BlueScoreGrabAuto);
        ...
        m_chooser.addOption("Blue - Cube Score Charge Station", BlueCubeScoreCSAuto);
        m_chooser.addOption("Red - Top Score Grab", RedScoreGrabAuto);
        ...
        m_chooser.addOption("Red - Cube Score Charge Station", RedCubeScoreCSAuto);

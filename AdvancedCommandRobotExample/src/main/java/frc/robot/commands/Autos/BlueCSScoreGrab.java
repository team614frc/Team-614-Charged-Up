...
public class BlueCSScoreGrab extends SequentialCommandGroup {
  /** Creates a new BlueCSScoreGrab. */
  public BlueCSScoreGrab() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new ScoreMidCubeAuto(),
        new PathPlannerLoadEventMapCommand("BlueCSScoreGrab", EventMap.Grab1()).withTimeout(15));
  }
}

...
public class RedCSSCoreGrab extends SequentialCommandGroup {
  /** Creates a new RedCSSCoreGrab. */
  public RedCSSCoreGrab() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new ScoreMidCubeAuto(),
        new PathPlannerLoadEventMapCommand("RedCSSCoreGrab", EventMap.Grab1()).withTimeout(15));
  }
}
